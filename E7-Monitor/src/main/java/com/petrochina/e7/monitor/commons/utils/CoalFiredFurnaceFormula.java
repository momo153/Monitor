...
public class CoalFiredFurnaceFormula {
    ...
    //TODO: 这里燃料干燥基比热容被写死0.25，而标准里只有无烟煤贫煤0.92，烟煤0.96，褐煤 1.09

    /**
     * @param fuelABM 燃料应用基水分  Fuel application base moisture 测试参数  单位：%
     * @return java.lang.Double
     * @Date 10:59 2019/6/21
     * @description :   燃料比热    Fuel specific heat     单位：kJ/kg ·℃      原公式：((100-param)/100*0.25+param/100)*4.1868
     **/
...
//        Double result = (25 + 0.75 * param) / 100 * 4.1868;
    ...
    /**
     * @param fuelSpecificHeat 燃料比热    Fuel specific heat  计算参数     单位：kJ/kg ·℃
