 ...
 **/
public class GasHeatingFurnaceFormula2 {
    ...
    public static Double waterEnthalpy(String waterTemp) {
        ...
        Double result = (param + 0.1) * PARAM1;
     ...
     **/
    public static Double positivePalanceEffic(Double boilerOutput, Double inputHeat) {
     ...
     **/
    public static Double positivePalanceEffic(String mediaFlow, String drainageTemp, String influentTemp, String fuelTemp, String fuelSpecificHeat, String lowFuelCalorificValue, String gasVolume) {
        return positivePalanceEffic(boilerOutput(mediaFlow, drainageTemp, influentTemp), inputHeat(fuelTemp, fuelSpecificHeat, lowFuelCalorificValue, gasVolume));
    }
     ...
     * @return java.lang.Double
     * @Date 16:44 2019/7/1
     * @description :  负荷率  Load rate    %    公式：param1 / (param2 * 3600000) * 100 TODO:公式来源是别的标注
     **/
...
//    }
    ...
    //TODO: 需要参数
    //额定容量，运行负荷，额定散热，额定热功率
    //ratedCapacity        额定容量  Rated Capacity    现场录入    MW
    //operatingLoad       运行负荷 Operating load   计算参数   kj/h
    //ratedHeatDissipation 额定散热   Rated heat dissipation  查表参数    %
    //ratedThermalPower    额定热功率    Rated thermal power     MW
    public static Double heatDissipation(String ratedCapacity, Double operatingLoad, String ratedHeatDissipation, String ratedThermalPower) {
        return null;
    }

    private Double tempMethod1(){
        return null;
    }
     ...
     * @return java.lang.Double
     * @Date 11:12 2019/7/4
     * @description :   各项热损失之和   The sum of heat loss    %
     **/
     ...
     * @description :   反平衡效率 Reverse balance thermal efficiency    %     原公式：100-param
     **/
     ...
     * @return java.lang.Double
     * @Date 11:12 2019/7/4
     * @description :   反平衡效率 Reverse balance thermal efficiency    %
     **/
    public static Double reversePalanceEffic(String mediaFlow, String drainageTemp, String influentTemp, String ratedCapacity, String ratedHeatDissipation, Double airCoefficient, String exhaustCOContent, String exhaustTemp, String airTemp) {
        return reversePalanceEffic(heatLossSum(mediaFlow, drainageTemp, influentTemp, ratedCapacity, ratedHeatDissipation, airCoefficient, exhaustCOContent, exhaustTemp, airTemp));
    }

    /**
     * @param positivePalanceEffic 正平衡效率 Positive balance thermal efficiency    单位：%
     ...
     **/
    public static Double furnaceEfficiency(Double positivePalanceEffic, Double reversePalanceEffic) {
        Double result = (positivePalanceEffic + reversePalanceEffic) / 2;
        return DoubleUtil.round(result, 2);
    }
    ...
    public static Double furnaceEfficiency(String mediaFlow, String drainageTemp, String influentTemp, String fuelTemp, String fuelSpecificHeat, String lowFuelCalorificValue, String gasVolume, String ratedCapacity, String ratedHeatDissipation, Double airCoefficient, String exhaustCOContent, String exhaustTemp, String airTemp) {
        return furnaceEfficiency(positivePalanceEffic(mediaFlow, drainageTemp, influentTemp, fuelTemp, fuelSpecificHeat, lowFuelCalorificValue, gasVolume), reversePalanceEffic(mediaFlow, drainageTemp, influentTemp, ratedCapacity, ratedHeatDissipation, airCoefficient, exhaustCOContent, exhaustTemp, airTemp));
    }
}
